  // sonar: sonar-scanner.bat -D"sonar.projectKey=calculator-pro-v2" -D"sonar.sources=." -D"sonar.host.url=http://localhost:9000" -D"sonar.login=1cafb6da1242fb591c293ac3729f228aaed4a14b"
...
function SquareRoot(){
        ...
        if (savedArray.length === 1){
                ...
                if(!Number.isInteger(squareRootResult)) {squareRootResult = squareRootResult.toFixed(3);}
                       ...
                       console.log("RESULT: Square root of the first parameter: " + squareRootResult);
